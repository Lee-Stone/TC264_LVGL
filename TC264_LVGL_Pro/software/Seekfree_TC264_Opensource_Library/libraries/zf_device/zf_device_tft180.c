...
#include "zf_device_tft180.h"
        ...
        uint16                   tft180_width_max    = 160;//160
		uint16                   tft180_height_max   = 128;//128
...
void tft180_set_dir (tft180_dir_enum dir)
{
    ...
    switch(tft180_display_dir)
    {
        ...
        case TFT280_PORTAIT:
        case TFT280_PORTAIT_180:
        {
            tft180_width_max = 240;
            tft180_height_max = 320;
        }break;
        case TFT280_CROSSWISE:
        case TFT280_CROSSWISE_180:
        {
            tft180_width_max = 320;
            tft180_height_max = 240;
        }break;
    }
}
...
void tft180_init (void)
{
    ...
    switch(tft180_display_dir)                                                  // y x v
    {
        ...
        case TFT280_PORTAIT:        tft180_write_8bit_data(1<<7 | 1<<6 | 0<<5);  break;
        case TFT280_PORTAIT_180:    tft180_write_8bit_data(0<<7 | 0<<6 | 0<<5);  break;
        case TFT280_CROSSWISE:      tft180_write_8bit_data(1<<7 | 0<<6 | 1<<5);  break;
        case TFT280_CROSSWISE_180:  tft180_write_8bit_data(0<<7 | 1<<6 | 1<<5);  break;
    }
