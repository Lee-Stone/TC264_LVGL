...
code/lvgl/src/misc/%.src: ../code/lvgl/src/misc/%.c code/lvgl/src/misc/subdir.mk
	@echo 'Building file: $<'
	...
	if [ -f "$(basename $@).d" ]; then sed.exe -r  -e 's/\b(.+\.o)\b/code\/lvgl\/src\/misc\/\1/g' -e 's/\\/\//g' -e 's/\/\//\//g' -e 's/"//g' -e 's/([a-zA-Z]:\/)/\L\1/g' -e 's/\d32:/@TARGET_DELIMITER@/g; s/\\\d32/@ESCAPED_SPACE@/g; s/\d32/\\\d32/g; s/@ESCAPED_SPACE@/\\\d32/g; s/@TARGET_DELIMITER@/\d32:/g' "$(basename $@).d" > "$(basename $@).d_sed" && cp "$(basename $@).d_sed" "$(basename $@).d" && rm -f "$(basename $@).d_sed" 2>/dev/null; else echo 'No dependency file to process';fi
	@echo 'Finished building: $<'
	@echo ' '

code/lvgl/src/misc/%.o: ./code/lvgl/src/misc/%.src code/lvgl/src/misc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-code-2f-lvgl-2f-src-2f-misc

clean-code-2f-lvgl-2f-src-2f-misc:
	-$(RM) ./code/lvgl/src/misc/lv_anim.d ./code/lvgl/src/misc/lv_anim.o ./code/lvgl/src/misc/lv_anim.src ./code/lvgl/src/misc/lv_anim_timeline.d ./code/lvgl/src/misc/lv_anim_timeline.o ./code/lvgl/src/misc/lv_anim_timeline.src ./code/lvgl/src/misc/lv_area.d ./code/lvgl/src/misc/lv_area.o ./code/lvgl/src/misc/lv_area.src ./code/lvgl/src/misc/lv_async.d ./code/lvgl/src/misc/lv_async.o ./code/lvgl/src/misc/lv_async.src ./code/lvgl/src/misc/lv_bidi.d ./code/lvgl/src/misc/lv_bidi.o ./code/lvgl/src/misc/lv_bidi.src ./code/lvgl/src/misc/lv_color.d ./code/lvgl/src/misc/lv_color.o ./code/lvgl/src/misc/lv_color.src ./code/lvgl/src/misc/lv_fs.d ./code/lvgl/src/misc/lv_fs.o ./code/lvgl/src/misc/lv_fs.src ./code/lvgl/src/misc/lv_gc.d ./code/lvgl/src/misc/lv_gc.o ./code/lvgl/src/misc/lv_gc.src ./code/lvgl/src/misc/lv_ll.d ./code/lvgl/src/misc/lv_ll.o ./code/lvgl/src/misc/lv_ll.src ./code/lvgl/src/misc/lv_log.d ./code/lvgl/src/misc/lv_log.o ./code/lvgl/src/misc/lv_log.src ./code/lvgl/src/misc/lv_lru.d ./code/lvgl/src/misc/lv_lru.o ./code/lvgl/src/misc/lv_lru.src ./code/lvgl/src/misc/lv_math.d ./code/lvgl/src/misc/lv_math.o ./code/lvgl/src/misc/lv_math.src ./code/lvgl/src/misc/lv_mem.d ./code/lvgl/src/misc/lv_mem.o ./code/lvgl/src/misc/lv_mem.src ./code/lvgl/src/misc/lv_printf.d ./code/lvgl/src/misc/lv_printf.o ./code/lvgl/src/misc/lv_printf.src ./code/lvgl/src/misc/lv_style.d ./code/lvgl/src/misc/lv_style.o ./code/lvgl/src/misc/lv_style.src ./code/lvgl/src/misc/lv_style_gen.d ./code/lvgl/src/misc/lv_style_gen.o ./code/lvgl/src/misc/lv_style_gen.src ./code/lvgl/src/misc/lv_templ.d ./code/lvgl/src/misc/lv_templ.o ./code/lvgl/src/misc/lv_templ.src ./code/lvgl/src/misc/lv_timer.d ./code/lvgl/src/misc/lv_timer.o ./code/lvgl/src/misc/lv_timer.src ./code/lvgl/src/misc/lv_tlsf.d ./code/lvgl/src/misc/lv_tlsf.o ./code/lvgl/src/misc/lv_tlsf.src ./code/lvgl/src/misc/lv_txt.d ./code/lvgl/src/misc/lv_txt.o ./code/lvgl/src/misc/lv_txt.src ./code/lvgl/src/misc/lv_txt_ap.d ./code/lvgl/src/misc/lv_txt_ap.o ./code/lvgl/src/misc/lv_txt_ap.src ./code/lvgl/src/misc/lv_utils.d ./code/lvgl/src/misc/lv_utils.o ./code/lvgl/src/misc/lv_utils.src

.PHONY: clean-code-2f-lvgl-2f-src-2f-misc
